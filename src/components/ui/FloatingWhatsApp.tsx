  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 animate-fade-in group">
      ...
      <a
        ...
        style={{ animation: 'whatsapp-bounce 2.5s ease-in-out infinite' }}
        aria-label="Fale conosco pelo WhatsApp"
      >
        <span className="absolute right-16 px-3 py-1.5 bg-white text-black text-sm rounded-lg opacity-0 group-hover:opacity-100 whitespace-nowrap shadow-md pointer-events-none transition-opacity duration-300">
          Chamar no WhatsApp
        </span>
        <svg
