...
export default function Stepper({
    ...
    return (
        <div className="outer-container" {...rest}>
            <div className={`step-circle-container ${stepCircleContainerClassName}`} style={{ border: '1px solid #333' }}>
        ...
        <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
            <motion.div
                variants={{
                    ...
                    active: { scale: 1, backgroundColor: '#B3936C', color: '#B3936C' },
                    complete: { scale: 1, backgroundColor: '#B3936C', color: '#F5E4AE' }
                }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
    const lineVariants = {
        ...
        complete: { width: '100%', backgroundColor: '#B3936C' }
    };
