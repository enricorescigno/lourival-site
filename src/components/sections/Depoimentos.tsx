        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {depoimentos.map((d, i) => (
            <div key={i} className="bg-white border border-border rounded-lg overflow-hidden flex flex-col">
              <div className="h-56 bg-neutral-900 flex items-center justify-center relative overflow-hidden">
                {d.antes && d.depois ? (
                  <>
                    ...
                    <div className="w-1/2 h-full overflow-hidden">
                      <img src={d.antes} alt="Antes" className="w-full h-full object-cover" />
                    </div>
                    <div className="w-px h-full bg-white/30 flex-shrink-0" />
                    <div className="w-1/2 h-full overflow-hidden">
                      <img src={d.depois} alt="Depois" className="w-full h-full object-cover" />
                    </div>
                  </>
                ) : (
                  <>
              ...
              <div className="p-6 bg-white flex-1">
                ...
                <p className="text-black/70 text-xs leading-relaxed text-center">{d.texto}</p>
              </div>
            </div>
          ))}
        </div>
