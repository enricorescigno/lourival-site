    ...
    <footer className="py-6 border-t border-border bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-6 text-center md:text-left">
          ...
          {/* Right: Informational Links & VRFF */}
          <div className="flex flex-col items-center md:items-end gap-3 mt-4 md:mt-0">
            <div className="flex flex-col items-center md:items-end gap-1">
              <a href="http://www2.cirurgiaplastica.org.br/" target="_blank" rel="nofollow noopener noreferrer" className="text-muted-foreground text-[10px] hover:text-primary transition-colors">
                Membro da Sociedade Brasileira de Cirurgia Plástica (SBCP)
              </a>
              <a href="https://portal.cfm.org.br/" target="_blank" rel="nofollow noopener noreferrer" className="text-muted-foreground text-[10px] hover:text-primary transition-colors">
                Conselho Federal de Medicina Médica
              </a>
            </div>
            <div className="flex items-center gap-2">
              <p className="text-muted-foreground text-xs">Feito por</p>
              <img src={vrffLogo} alt="VRF&F" className="h-6" />
            </div>
          </div>
        </div>
      </div>
