          ...
          {solucoes.map((s, i) => (
            <div key={i} className="bg-card border border-border rounded-lg overflow-hidden group hover:border-primary/30 transition-colors flex flex-col">
              ...
              <div className="p-6 flex flex-col flex-1">
                ...
                <a
                  href="#contato"
                  className="mt-auto inline-block w-full text-center bg-[radial-gradient(50%_50%_at_50%_50%,#F5E4AE_0%,#B3936C_100%)] text-black font-montserrat text-xs uppercase tracking-wider px-4 py-3 hover:opacity-90 transition-all font-bold"
                >
